...
<?php
if (
    isset($_GET['uid']) || isset($_GET['message']) || isset($_GET['umsg']) ||
...
if (isset($_GET['message'])) {
    ...
    <div class="m-2 alert alert-danger alert-dismissible fade show" role="alert">
        <strong>Fill all the details..!</strong><button type="button" class="btn-close" data-bs-dismiss="alert"
...
if (isset($_GET['umsg'])) {
    ...
    <div class="m-2 alert alert-warning alert-dismissible fade show" role="alert">
        <strong>Fill all the details..! check Gender</strong><button type="button" class="btn-close" data-bs-dismiss="alert"
            aria-label="Close"></button>
    </div>
    <?php
}
...
if (isset($_GET['uexist'])) {
    ?>
    <div class="m-2 alert alert-warning alert-dismissible fade show" role="alert">
        <strong>User with email exist plase use different email</strong><button type="button" class="btn-close"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="text-danger" id="passError">
                            <ul>
                                ...
                                <li>it should contain 1 capital alphabet 1 small aplhabet and 1 number 1 special
                                    charatcer</li>
                            </ul>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" onkeypress="return /[0-9]/i.test(event.key)" class="form-control" name="age"
                            id="ageId">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        <label for="age" class="form-label">Age</label>
                        <input type="text" id="age" onkeypress="return /[0-9]/i.test(event.key)" class="form-control"
                            name="age" required>
                        <div class="invalid-feedback">please enter age</div>
                    </div>
                    <label for="genderName" class="form-label">Gender</label>
                    <div class="form-check">
                        <input id="gender" class="form-check-input" type="radio" value="Male" name="gender" required>
                        <label class="form-check-label" for="gender" value="Male" name="gender">Male</label>
                        <div class="invalid-feedback">please select gender</div>
                    </div>
                    <div class="form-check">
                        <input id="gender" class="form-check-input" type="radio" value="Female" name="gender" required>
                        <label class="form-check-label" for="gender" value="Female" name="gender">Female</label>
                        <div class="invalid-feedback">please select gender</div>
                    </div>
                    <div class="form-group mb-3">
                    ...
                    <div class="form-group mb-3">
                        <label for="salary" class="form-label">Salary</label>
                        <input id="salary" type="text" onkeypress="return /[0-9]/i.test(event.key)" class="form-control"
